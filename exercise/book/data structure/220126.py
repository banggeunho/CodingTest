...
# Date : 2022. 01. 26.
# 자료구조(Data Structure)의 graph search/BFS를 위한 개념 공부
...
# graph search(Depth-First-Search) : 깊이 우선 탐색, 그래프에서 깊은 부분을 우선적으로 탐색하는 알고리즘
...
# graph search 동작원리 : 스택 // 구현 방법 : 재귀 함수 이용
